...
public class Stage extends JPanel implements ActionListener {
	 ...
	 * @param score
	 */
	//this method should be private but is currently public for JUnit
	...
	/*
	 * These getters and setters are to help with JUnit tests
	 * Was hard to make JUnits with GUI so a lot of tests are making
	 * sure things have properly been created
	 * After implementation, these can be commented out because they're
	 * not used to actually run the code
	 */

	/**
	 * Getter for boxes array list
	 * @return
	 */
	...
	/**
	 * Setter for the array list of boxes
	 * @param boxes
	 */
	...
	/**
	 * Setter for coins array list
	 * Not actually tested but a coins array list is needed
	 * for the program to properly run
	 * @param coins
	 */
	...
	/**
	 * Setter to set the high score (to test scoring method)
	 * @param prevHighScore
	 */
	public void setHighScore(int prevHighScore) {
